...
calculation = ""  # makes calculation empty at start
...
btn_clear = tk.Button(root, text="C", command=clear_field, width=5, font="Arial")
btn_clear.grid(row=6, column=4)
btn_equals = tk.Button(root, text="=", command=evaluate_calc, width=5, font="Arial")
